...
1. 前往 [Releases](https://github.com/HaoJi666/claude-usage-monitor/releases) 下載最新的 **Universal macOS** 版本：
   - `Claude.Usage.Monitor_*_universal.dmg`
...
輸出在 `src-tauri/target/universal-apple-darwin/release/bundle/dmg/`。
